...
class InstructionConfigurationScreen extends HookConsumerWidget {
  const InstructionConfigurationScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Instruction configuration')),
      body: SafeArea(
        child: ListView(
